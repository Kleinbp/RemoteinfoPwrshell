...
$output | Add-Member -MemberType NoteProperty -Name 'Serial Number' -Value $ComputerInfo.BiosSeralNumber

$output | Add-Member -MemberType NoteProperty -Name 'IP Address' -Value $IP.IPv4Address.IPaddress

$output | Add-Member -MemberType NoteProperty -Name 'Build Version' -Value $Computerinfo.WindowsBuildLabex

$output | Add-Member -MemberType NoteProperty -Name 'Windows Version' -Value $Computerinfo.windowsversion

$output | Add-Member -MemberType NoteProperty -Name 'Network Interface' -Value $NetworkAdapterinfo.InferfaceDescription

$output | Add-Member -MemberType NoteProperty -Name 'MAC' -Value $NetworkAdapterinfo.MacAddress

$output | Add-Member -MemberType NoteProperty -Name 'Inferface Speed' -Value $NetworkAdapterinfo.Linkspeed

$output | Add-Member -MemberType NoteProperty -Name 'Users w/ profile on system' -Value $Listofusers.name

$output | Add-Member -MemberType NoteProperty -Name 'DNS Servers' -Value $IP.DNSSERVER.Serveraddress
